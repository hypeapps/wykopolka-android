...
public class WykopUser {
    ...
    /**
     * @param publicEmail The public_email
     */
    @JsonProperty("public_email")
    ...
    /**
     * @param authorGroup The author_group
     */
    @JsonProperty("author_group")
    ...
    /**
     * @param linksAdded The links_added
     */
    @JsonProperty("links_added")
    ...
    /**
     * @param linksPublished The links_published
     */
    @JsonProperty("links_published")
    ...
    /**
     * @param entriesComments The entries_comments
     */
    @JsonProperty("entries_comments")
    ...
    /**
     * @param relatedLinks The related_links
     */
    @JsonProperty("related_links")
    ...
    /**
     * @param signupDate The signup_date
     */
    @JsonProperty("signup_date")
    ...
    /**
     * @param avatarBig The avatar_big
     */
    @JsonProperty("avatar_big")
    ...
    /**
     * @param avatarMed The avatar_med
     */
    @JsonProperty("avatar_med")
    ...
    /**
     * @param isObserved The is_observed
     */
    @JsonProperty("is_observed")
    ...
    /**
     * @param violationUrl The violation_url
     */
    @JsonProperty("violation_url")
